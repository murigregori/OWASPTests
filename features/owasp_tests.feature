...
Scenario: User successfully buys an item from the OWASP Juice Shop 
  Given the user has added "Apple Juice (1000ml)" to the cart
...
Scenario: User leaves a review for a product in the OWASP Juice Shop
  ...
  Given the user is in the Home page
   When the user leaves a review for "Apple Juice (1000ml)"
   Then the user should be notified that the review has been submitted